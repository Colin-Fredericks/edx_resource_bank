...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Custom_Text_Value'
        db.create_table(u'RDB_custom_text_value', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['RDB.Custom_Text'])),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'RDB', ['Custom_Text_Value'])
        ...
        db.create_table(u'RDB_resource', (
            ...
            ('custom_text_value', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['RDB.Custom_Text_Value'], null=True, blank=True)),
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Custom_Text_Value'
        db.delete_table(u'RDB_custom_text_value')
    ...
    models = {
        ...
        u'RDB.custom_text_value': {
            'Meta': {'object_name': 'Custom_Text_Value'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['RDB.Custom_Text']"}),
        ...
        u'RDB.resource': {
            ...
            'custom_text_value': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['RDB.Custom_Text_Value']", 'null': 'True', 'blank': 'True'}),
